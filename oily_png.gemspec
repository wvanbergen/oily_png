Gem::Specification.new do |s|
  ...
  # automatically by the gem release script.
  s.files      = %w(.gitignore Gemfile Gemfile.lock LICENSE README.rdoc Rakefile ext/oily_png/Makefile ext/oily_png/extconf.rb ext/oily_png/oily_png.c oily_png.gemspec tasks/github-gem.rake test.png test.rb)
  s.test_files = %w()
end
