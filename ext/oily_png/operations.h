...
/* 
  C replacement method for composing another image onto a duplicate of this image using alpha blending.
...
*/
VALUE oily_png_compose(int argc, VALUE *argv, VALUE c);
